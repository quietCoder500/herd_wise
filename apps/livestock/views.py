...
def animal_group_list(request, farm_short_uuid):
    animal_groups = get_list_or_404(AnimalGroup, farm__users=request.user, farm__public_id=farm_short_uuid)
    return render(request, "livestock/animal_group/list.html", context={"animal_groups": animal_groups})
